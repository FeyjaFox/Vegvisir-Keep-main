...
//	winset(client, "outputwindow.output", "max-lines=100")
	...
	if(client)
		if(client.is_new_player())
			to_chat(src, span_userdanger("Due to an invasion of goblins trying to play Vegvisir Keep, you need to register your discord account or support us on patreon to join."))
