...
/area/rogue/placeholder1
	name = "placeholder1"
	icon_state = "placeholdera"
	droning_sound = 'sound/music/area/dungeonclearing.ogg'

/area/rogue/placeholder2
	name = "placeholder2"
	icon_state = "placeholderb"
	droning_sound = 'sound/music/area/triumphantintense.ogg'

/area/rogue/placeholder3
	name = "placeholder3"
	icon_state = "placeholderc"
	droning_sound = 'sound/music/area/acm.ogg'

/area/rogue/placeholder4
	name = "placeholder4"
	icon_state = "placeholderd"
	droning_sound = 'sound/music/area/acm.ogg'

/area/rogue/placeholder5
	name = "placeholder5"
	icon_state = "placeholdere"
	droning_sound = 'sound/music/area/acm.ogg'

/area/rogue/placeholder6
	name = "placeholder6"
	icon_state = "placeholderf"
	droning_sound = 'sound/music/area/acm.ogg'

/area/rogue/placeholder7
	name = "placeholder7"
	icon_state = "placeholderg"
	droning_sound = 'sound/music/area/acm.ogg'

/area/rogue/placeholder8
	name = "placeholder8"
	icon_state = "placeholderh"
	droning_sound = 'sound/music/area/acm.ogg'

/area/rogue/placeholder9
	name = "placeholder9"
	icon_state = "placeholderi"
	droning_sound = 'sound/music/area/acm.ogg'

/area/rogue/placeholder10
	name = "placeholder10"
	icon_state = "placeholderj"
	droning_sound = 'sound/music/area/acm.ogg'
